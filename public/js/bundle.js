...
var producerSignUp = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(producerName, prodStyle, minSamplesPerPack, artistType, subscriptionName, description, price) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
  ...
  return function producerSignUp(_x, _x2, _x3, _x4, _x5, _x6, _x7) {
    return _ref.apply(this, arguments);
  };
}();
...
if (producerForm) {
  producerForm.addEventListener('submit', function (e) {
    ...
    (0, _prodSignUp.producerSignUp)(producerName, prodStyle, minSamplesPerPack, artistType, subscriptionName, description, price);
  });
}
