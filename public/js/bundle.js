...
var subscribeToProducer = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(producerId) {
    var _yield$axios, data, stripeSession, stripe;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            stripeSession = data.session.id;
            _context.next = 7;
            return (0, _stripeJs.loadStripe)('pk_test_51KNkkAEN94GceQk7xMydvj4Z92ePfTeP833VEZZYJ4emL3bfHYulhPxlPjjhX2W6xpgzplbWh0AhhKBJ0o1O3HQA00Ye60XICc');
...
if (producerForm) {
  producerForm.addEventListener('submit', function (e) {
    ...
    (0, _prodSignUp.producerSignUp)(producerName, prodStyle, minSamplesPerPack, artistType, youtubeLink, subscriptionName, description, price);
  });
}
