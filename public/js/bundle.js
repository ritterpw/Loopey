...
var signUp = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(firstName, lastName, email, password, passwordConfirmed, role) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"prodSignUp.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.producerSignUp = void 0;
...
var producerSignUp = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(producerName, prodStyle, minSamplesPerPack, artistType, youtubeLink, subscriptionName, description, price) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              ...
              data: {
                ...
                prodStyle: prodStyle,
                country: country,
                minSamplesPerPack: minSamplesPerPack,
  ...
  return function producerSignUp(_x, _x2, _x3, _x4, _x5, _x6, _x7, _x8) {
    return _ref.apply(this, arguments);
  };
}();

exports.producerSignUp = producerSignUp;
...
exports.subscribeToProducer = void 0;
...
var subscribeToProducer = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(producerId) {
    var _yield$axios, producer, user;
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return (0, _axios.default)("/api/v1/subscriptions/checkout-session/".concat(producerId));

          case 2:
            _yield$axios = _context.sent;
            producer = _yield$axios.producer;
            user = _yield$axios.user;
            ...
            // );
            console.log(producer, user); // await stripe.redirectToCheckout({ sessionId: stripeSession });

            (0, _alert.showAlert)('success', 'Successfully Subscribed!');
  ...
  return function subscribeToProducer(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.subscribeToProducer = subscribeToProducer;
...
var _prodSignUp = require("./prodSignUp");
...
var subscribeBtn = document.getElementById('subscribe-to-producer');
var signupForm = document.querySelector('.form--signup');
var producerForm = document.querySelector('.form--producer');
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    ...
    var email = document.getElementById('email').value;
    var password = document.getElementById('password').value;
    var passwordConfirmed = document.getElementById('password-confirm').value;
    (0, _signUp.signUp)(firstName, lastName, email, password, passwordConfirmed);
  });
}
...
if (subscribeBtn) subscribeBtn.addEventListener('click', function (e) {
  e.target.textContent = 'Processing...';
  var producerId = e.target.dataset.producerId;
  (0, _stripe.subscribeToProducer)(producerId);
});
...
if (producerForm) {
  producerForm.addEventListener('submit', function (e) {
    ...
    var prodStyle = document.getElementById('prodStyle').value;
    var country = document.getElementById('country').value;
    var minSamplesPerPack = document.getElementById('minSamplesPerPack').value;
